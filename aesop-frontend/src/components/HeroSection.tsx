...
//               {/* Left Content */}
//               <div
//                 className={` space-y-6 lg:col-span-1 ${index % 2 === 1 ? 'lg:col-start-3' : ''}`}
//               >
//                 {hero.Category && (
...
//               {/* Right Image */}
//               <div
//                 className={`relative lg:col-span-2 ${index % 2 === 1 ? 'lg:col-start-1' : ''}`}
//               >
//                 {hero.Image ? (
...
//           <div className="w-full h-37 bg-white"></div>
//         </div>
//       ))}
//     </div>
//   );
...
//           <section className="container mx-auto px-4 py-8">
//             <div
//               className={`grid grid-cols-1 lg:grid-cols-4 gap-5 items-center ${
//                 index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''
//               }`}
//             >
//               {/* Left Spacer (blank space) */}
...
//               {/* Left Content */}
//               <div
//                 className={`space-y-6 lg:col-span-1 lg:col-start-2 ${
